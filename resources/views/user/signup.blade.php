                ...
                <div class="card">
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group{{ $errors->has('town') ? ' has-error' : '' }}">
                            <label for="address" class="col-md-4 control-label">Town</label>
                        ...
                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="postaladdress" type="integer" class="form-control" name="postaladdress" value="{{ old('postaladdress') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="integer" class="form-control" name="phone" value="{{ old('phone') }}" required min:10>
                                @if ($errors->has('phone'))
                                    <span class="help-block">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <p>Already have an account? <a href="{{ route('user.signin')}}">Login instead </a></p>
                            </div>
                        </div>
                    </form>
                </div>
