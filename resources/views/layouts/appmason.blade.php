...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
           ...
           <span class="logo-lg">Kanini Haraka Enterprises supplier</b></span>
           <!-- <img src="images/favicon.png" class="img-circle" alt=""> -->
           @endif
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <div class="pull-left">
                                        <a href="{{URL::to('supplierprofile')}}" class="btn btn-default btn-flat"> <i class="fa fa-user"></i>Manage Profile</a>
                                    </div>

                                    <div class="pull-right">
                                        <a href="{{URL::to('supplierslogout')}}" class="btn btn-default btn-flat"> <i class="fa fa-sign-out"></i> Sign out</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
...
<ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{URL::to('supplierprofile')}}"><i class="fa fa-clone"></i> Update Profile</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{URL::to('suppliershome')}}"><i class="fa fa-clone"></i>Supply Requests</a></li>
                            <li><a href="{{URL::to('supplierspending')}}"><i class="fa fa-money"></i> Pending Requests</a></li>
                            <li><a href="{{URL::to('suppliersaccepted')}}"><i class="fa fa-money"></i>Accepted Supplies</a></li>
                            <li><a href="{{URL::to('suppliersconfirmed')}}"><i class="fa fa-money"></i>Confirmed Supplies</a></li>
                        </ul>
                    </li>
                    
                    <li>
                        <a href="{{URL::to('supplierslogout')}}">
