...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
           ...
           @else
                 <!-- logo for regular state and mobile devices -->
           <span class="logo-lg">Kanini Haraka Enterprises Fiance Controller</b></span>
           <!-- <img src="images/favicon.png" class="img-circle" alt=""> -->
           @endif
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <div class="pull-left">
                                        <a href="{{URL::to('accountantprofile')}}" class="btn btn-default btn-flat"> <i class="fa fa-user"></i>Manage Profile</a>
                                    </div>

                                    <div class="pull-right">
                                        <a href="{{URL::to('accountantslogout')}}" class="btn btn-default btn-flat"> <i class="fa fa-sign-out"></i> Sign out</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
