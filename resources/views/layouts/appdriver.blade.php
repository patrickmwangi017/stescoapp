...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
           ...
           <span class="logo-lg">Kanini Haraka Enterprises Driver</b></span>
           <!-- <img src="images/favicon.png" class="img-circle" alt=""> -->
           @endif
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <div class="pull-left">
                                        <a href="{{URL::to('driverprofile')}}" class="btn btn-default btn-flat"> <i class="fa fa-user"></i>Manage Profile</a>
                                    </div>

                                    <div class="pull-right">
                                        <a href="{{URL::to('driverslogout')}}" class="btn btn-default btn-flat"> <i class="fa fa-sign-out"></i> Sign out</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
...
<ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{URL::to('drivershome')}}"><i class="fa fa-clone"></i> Allocated Shipments</a></li>
                            <li><a href="{{URL::to('driverspending')}}"><i class="fa fa-money"></i> Pending Shipments</a></li>
                            <li><a href="{{URL::to('driversdelivered')}}"><i class="fa fa-money"></i> Delivered Shipments</a></li>
                            <li><a href="{{URL::to('driversconfirmed')}}"><i class="fa fa-money"></i> Confirmed Deliveries</a></li>
                        </ul>
                    </li>
