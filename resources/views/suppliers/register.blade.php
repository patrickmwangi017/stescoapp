    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">suppliers Register</div>

                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('suppliers.register') }}">
                        {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <p>Already have an account? <a href="{{ route('suppliers.login')}}">Login instead </a></p>
                            </div>
                        </div>
                    </form>
                </div>
