...
$w=array(20,20,40,40,30,30,30,20,18,15,15,15,15);
	...
	{ //width
		...
		$this->Cell(30,6,$eachResult["mpesa_code"],1);
                $this->Cell(30,6,$eachResult["totalexpected"],1);
                $this->Cell(30,6,$eachResult["status"],1);
		$this->Ln();
...
$header=array('Order ID','cust_id','Cust_name', 'destination', 'mpesa_code', 'total_price', 'status');
//Data loading
//*** Load MySQL Data ***//
//db settings
$db_username = 'root';
...
$pdf->AddPage();
	...
	$pdf->Cell(50);
	$pdf->Write(5, 'Kanini Haraka Order Detail Management');
	$pdf->Ln();
	...
	$result=mysqli_query($mysqli,"SELECT * FROM shipments ") or die ("Database query failed: $query" . mysql_error());
